...
<div class="drawer drawer-end">
    ...
    <div class="flex-1 px-2 mx-2 text-2xl">Clean Co</div>
      ...
      <div class="flex-none hidden lg:block">
        <ul class="menu menu-horizontal gap-x-2">          
          <li><NavLink className='rounded-lg hover:bg-primary' to='/home'>Home</NavLink></li>
          <li><NavLink className='rounded-lg' to='/about'>About</NavLink></li>
          <li><NavLink className='rounded-lg' to='/services'>Service</NavLink></li>
  ...
  <label tabIndex={0} className="btn btn-outline border-primary hover:bg-primary hover:border-none rounded-lg m-1">BOOK NOW</label>
  <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-primary rounded-box w-52">
    <li><a className='text-base-100'>Item 1</a></li>
    <li><a className='text-base-100'>Item 2</a></li>
  </ul>
</li>
<li>
